...
namespace Business_Tier
{
    public class Sets : Spel
    {
        ...
        public Sets(string speler1, string speler2, int scoreP1, int scoreP2, int gmd1, int gmd2, int count1, int count2, int startScore, int setsStand1, int setsStand2, int setsTotaal)
